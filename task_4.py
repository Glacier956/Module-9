...
while True:
  step = input("[Программа]: Марсоход находится на позиции " + str(y) + ", " + str(x) + ", введите команду:\n[Оператор]: ")
  if step == "A" or step == "a" and x != 0:
    x -= 1
  elif step == "D" or step == "d" and x != 15:
    x += 1
  elif step == "W" or step == "w" and y != 20:
    y += 1
  elif step == "S" or step == "s" and y != 0:
    y -= 1
